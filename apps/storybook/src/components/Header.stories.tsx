...
const introBody = (
  <div style={{ maxWidth: "42rem" }}>
    ...
    <p>Programma's met werken van Debussy, Ravel en Poulenc, uitgevoerd in intieme concertzalen.</p>
  </div>
);
...
const sectionBody = (
  <div style={{ maxWidth: "42rem" }}>
    ...
    <p>
      Een compacte introductie voor tussenliggende paginasecties met dezelfde visuele behandeling
      als de paginakop.
    </p>
  </div>
);
