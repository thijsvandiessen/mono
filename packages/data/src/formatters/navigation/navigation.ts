...
import type { NavigationData, NavigationItem, SubMenuItem } from "../../types/navigation.js";

import { navigationDataSchema, navigationItemSchema, navigationSubMenuSchema } from "./schema.js";
...
export const navigationFormatter = (general?: GeneralInfoFragment): NavigationData => {
