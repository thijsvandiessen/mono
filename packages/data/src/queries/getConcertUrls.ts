import type { GetConcertsUrlsQuery, GetConcertsUrlsQueryVariables } from "../generated/graphql.js";
...
> = gql`
  query getConcertsUrls($skip: IntType!, $first: IntType!, $order: [ConcertModelOrderBy]) {
