...
import { navigationFormatter } from "../formatters/index.js";
...
const getGeneralInfoDocument: DocumentInput<GetGeneralInfoQuery, GetGeneralInfoQueryVariables> =
  GetGeneralInfoDocument;
...
export const getGeneralInfo = async (): Promise<{
  ...
  try {
    const { data } = await client.query<GetGeneralInfoQuery, GetGeneralInfoQueryVariables>(
      getGeneralInfoDocument,
      {},
    );
