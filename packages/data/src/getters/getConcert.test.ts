import { GetConcertDocument } from '../generated/graphql.js'
import { client } from '../gqlClient.js'
import { getConcert } from './getConcert.js'
...
describe('getConcert', () => {
  it('should return an object', async () => {
    ...
    const { data } = await getConcert({ id: '186234305' })
    expect(data).toEqual({
      id: '186234305',
      image: undefined,
      locations: [],
  ...
  it('should return an error', async () => {
    ...
    const { data, error } = await getConcert({ id: '186234305' })
